...
export async function POST(request: NextRequest) {
  try {
    ...
    const { temple_id, name, material, price, sizes, colors, quantity, in_stock, display_order, allow_direct_payment, allow_cod } = body;
...
export async function PUT(request: NextRequest) {
  try {
    const body = await request.json();
    const { id, temple_id, name, material, price, sizes, colors, quantity, image_url, in_stock, display_order, allow_direct_payment, allow_cod } = body;
